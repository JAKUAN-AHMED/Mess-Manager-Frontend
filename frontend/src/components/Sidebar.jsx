...
import { LayoutDashboard, Users, Utensils, Receipt, Banknote, Wallet2, LogOut, ShieldCheck, Globe, X, KeyRound, Eye, EyeOff, CheckCircle, BookOpen } from 'lucide-react';
...
export function Sidebar({ isOpen, onClose }) {
  ...
  const navItems = [
    ...
    { name: 'অগ্রিম পেমেন্ট',      path: '/advance', icon: Wallet2 },
